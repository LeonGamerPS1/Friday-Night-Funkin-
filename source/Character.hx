...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				loadOffsetFile(curCharacter);
			case 'death':
				var tex = Paths.getSparrowAtlas('characters/Death', 'shared');
				frames = tex;
				...
				loadOffsetFile(curCharacter);
			case 'freed1':
				var tex = Paths.getSparrowAtlas('characters/freed1', 'shared');
				frames = tex;
				this.isPlayer = true;
				isPlayer = true;
				quickAnimAdd('idle', 'BF idle dance');
	...
	{
		var daFile:Array<String> = CoolUtil.coolTextFile("assets/characters/offsets/" + offsetCharacter + ".fnfoffset");
